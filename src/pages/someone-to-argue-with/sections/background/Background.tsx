      ...
      <div className={`wrapper-l ${style.content}`}>
        ...
        <div className="text-section">
          ...
          <p data-aos="fade-in">
            ...
            during the elections, the website was recorded with over 60,000
            users and 180,000 conversations between rightists and leftists.
            Articles on the major news sites in Israel and abroad were written
            on the website.
          </p>
        </div>
